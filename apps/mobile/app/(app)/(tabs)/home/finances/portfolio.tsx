 ...
 */
import { PortfolioScreen } from '../../../../../src/modules/finances/PortfolioScreen'

export default function FinancesPortfolio() {
  return <PortfolioScreen base="/home/finances" />
}
