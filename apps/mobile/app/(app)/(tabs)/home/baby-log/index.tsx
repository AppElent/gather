/**
 * A Child's log, mounted under home.
 *
 ...
 */
import { ChildScreen } from '../../../../../src/modules/baby/ChildScreen'

export default function BabyLogIndex() {
  return <ChildScreen base="/home/baby-log" />
}
