...
export const nl = {
  ...
  kitchen: {
    ...
    quickShort: '≤ {minutes} min',
    timeLimit: 'Tijdslimiet',
    noTimeLimit: 'Geen tijdslimiet',
    searchDinners: 'Zoek maaltijden en recepten',
    minutes: '{minutes} min',
    ...
    changeList: 'Andere lijst gebruiken',
    addGroceryItem: 'Item toevoegen…',
  ...
  labs: {
    ...
    notes: {
      ...
      editedByYou: 'Bewerkt {when} door jou',
      edited: 'Bewerkt {when}',
      pin: 'Vastzetten',
      unpin: 'Losmaken',
