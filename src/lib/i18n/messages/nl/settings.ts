...
export const settings = {
  ...
  connections: {
    ...
    disconnectedAccount: '{account} — losgekoppeld',
    connect: 'Koppelen',
    connectAnother: 'Nog een account koppelen',
    reconnect: 'Opnieuw koppelen',
    opening: 'Openen…',
    disconnect: 'Ontkoppelen',
    disconnectTitle: '{account} loskoppelen van {group}?',
    disconnectBody:
      'Lijsten die aan dit account hangen houden hun laatst bekende taken, alleen-lezen, totdat de koppeling is hersteld.',
